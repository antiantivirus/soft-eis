    ...
    <main className="grid place-items-center min-h-screen">
      <section>
        ...
        <div className="flex justify-between lg:block my-8">
          <Image
            className="lg:fixed top-10 left-10 lg:z-10"
            src="/blobs.png"
            width={80}
            height={160}
            alt=""
          />
          <Image
            className="lg:fixed bottom-[5%] left-[40%] lg:z-10"
            src="/star-fish.png"
            width={80}
            height={80}
            alt=""
          />
          <Image
            className="lg:fixed top-[13%] left-[18%] lg:z-10"
            src="/sad-apple.png"
            width={50}
            height={50}
            alt=""
          />
          <Image
            className="lg:fixed top-[8%] right-[10%] lg:z-10"
            src="/keychain.png"
            width={90}
            height={90}
            alt=""
