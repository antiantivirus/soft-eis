...
export default function PreOrder({ product }) {
  return (
    <div className="w-full mt-20 mb-28 lg:mt-0 lg:mb-8 lg:fixed lg:max-w-[400px] lg:top-1/2 lg:left-1/2 lg:transform lg:-translate-y-1/2 lg:-translate-x-1/2 lg:w-1/3 lg:z-10">
      <motion.div
